...
const SOCIAL_LINKS = [
  {
    name: 'Instagram',
    url: 'https://www.instagram.com/cl_aridane_/',
    icon: (
  ...
  {
    name: 'Facebook',
    url: 'https://www.facebook.com/profile.php?id=61594125023847',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
...
export default function Footer() {
  ...
  return (
    <footer
      className="bg-club-blue-dark dark:bg-gray-950 text-white"
      role="contentinfo"
    >
      {/* Franja decorativa */}
          ...
          <div>
            ...
            <ul className="space-y-2">
              {[
                ...
                { to: '/panel-socios', label: 'Panel de socios' },
              ].map(({ to, label }) => (
                <li key={to}>
                  <Link
                    to={to}
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-white/70">
              <li className="flex items-start gap-2">
                <svg
                  className="w-4 h-4 mt-0.5 text-club-orange flex-shrink-0"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
              ...
              <li className="flex items-center gap-2">
                <svg
                  className="w-4 h-4 text-club-orange flex-shrink-0"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link
                  ...
                  className="text-white/70 hover:text-club-orange transition-colors"
                >
                  {t('footer.privacidad')}
                </Link>
              </li>
