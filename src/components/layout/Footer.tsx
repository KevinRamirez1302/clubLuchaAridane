...
export default function Footer() {
  ...
  return (
    <footer className="bg-club-blue-dark dark:bg-gray-950 text-white" role="contentinfo">
      {/* Franja decorativa */}
      <div className="h-1 bg-gradient-to-r from-club-green via-club-orange to-club-blue-light" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            <h3 className="font-bold text-white mb-4 uppercase tracking-wider text-sm">Navegación</h3>
            <ul className="space-y-2">
              {[
                ...
                <li key={to}>
                  <Link
                    to={to}
                    className="text-white/70 hover:text-club-orange text-sm transition-colors"
                  >
                    {label}
                  </Link>
                </li>
          ...
          {/* Columna 3: Contacto */}
          <div>
            <h3 className="font-bold text-white mb-4 uppercase tracking-wider text-sm">Contacto</h3>
            <ul className="space-y-3 text-sm text-white/70">
              <li className="flex items-start gap-2">
                <svg className="w-4 h-4 mt-0.5 text-club-orange flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {/* Columna 4: Tienda + Legal */}
          <div>
            <h3 className="font-bold text-white mb-4 uppercase tracking-wider text-sm">Más</h3>
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <a href="#" className="text-white/70 hover:text-club-orange transition-colors">
                  {t('footer.privacidad')}
                </a>
              </li>
              <li>
